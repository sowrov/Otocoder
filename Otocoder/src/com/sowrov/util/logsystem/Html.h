#ifndef COM_SOWROV_UTIL_LOGSYSTEM_HTML_H_
#define COM_SOWROV_UTIL_LOGSYSTEM_HTML_H_
...
/**
 * <p>Implementaion of <code>LogFormatter</code> interface for HTML format</p>
 * 
 * <p>Instance of <code>Html</code> is immutable and threadsafe</p>
 *
 * <p><b>Requirements:</b>
 * <ul>
 ...
 * @version 1.0.0
 */
class Html : public LogFormatter {
private:
	std::string getFormat(std::string format, std::string str, int lineNo, std::string functionName, std::string fileName);
public:
