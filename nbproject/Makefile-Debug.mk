...
${OBJECTDIR}/Otocoder/src/com/sowrov/io/File.o: Otocoder/src/com/sowrov/io/File.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -IOtocoder/src -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Otocoder/src/com/sowrov/io/File.o Otocoder/src/com/sowrov/io/File.cpp
...
${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder/Method.o: Otocoder/src/com/sowrov/otocoder/Method.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -IOtocoder/src -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder/Method.o Otocoder/src/com/sowrov/otocoder/Method.cpp

${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder/Problem.o: Otocoder/src/com/sowrov/otocoder/Problem.cpp 
	${MKDIR} -p ${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder
	${RM} "$@.d"
	$(COMPILE.cc) -g -IOtocoder/src -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder/Problem.o Otocoder/src/com/sowrov/otocoder/Problem.cpp

${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder/ProblemInfo.o: Otocoder/src/com/sowrov/otocoder/ProblemInfo.cpp 
	${MKDIR} -p ${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder
	${RM} "$@.d"
	$(COMPILE.cc) -g -IOtocoder/src -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder/ProblemInfo.o Otocoder/src/com/sowrov/otocoder/ProblemInfo.cpp

${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder/TestData.o: Otocoder/src/com/sowrov/otocoder/TestData.cpp 
	${MKDIR} -p ${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder
	${RM} "$@.d"
	$(COMPILE.cc) -g -IOtocoder/src -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder/TestData.o Otocoder/src/com/sowrov/otocoder/TestData.cpp

${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder/Variable.o: Otocoder/src/com/sowrov/otocoder/Variable.cpp 
	${MKDIR} -p ${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder
	${RM} "$@.d"
	$(COMPILE.cc) -g -IOtocoder/src -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder/Variable.o Otocoder/src/com/sowrov/otocoder/Variable.cpp

${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder/VariableValue.o: Otocoder/src/com/sowrov/otocoder/VariableValue.cpp 
	${MKDIR} -p ${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder
	${RM} "$@.d"
	$(COMPILE.cc) -g -IOtocoder/src -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder/VariableValue.o Otocoder/src/com/sowrov/otocoder/VariableValue.cpp

${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder/argvparser.o: Otocoder/src/com/sowrov/otocoder/argvparser.cpp 
	${MKDIR} -p ${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder
	${RM} "$@.d"
	$(COMPILE.cc) -g -IOtocoder/src -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder/argvparser.o Otocoder/src/com/sowrov/otocoder/argvparser.cpp
...
${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder/codegen/CppCode.o: Otocoder/src/com/sowrov/otocoder/codegen/CppCode.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -IOtocoder/src -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder/codegen/CppCode.o Otocoder/src/com/sowrov/otocoder/codegen/CppCode.cpp

${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder/codegen/JavaCode.o: Otocoder/src/com/sowrov/otocoder/codegen/JavaCode.cpp 
	${MKDIR} -p ${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder/codegen
	${RM} "$@.d"
	$(COMPILE.cc) -g -IOtocoder/src -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder/codegen/JavaCode.o Otocoder/src/com/sowrov/otocoder/codegen/JavaCode.cpp
...
${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder/http/PageDownloader.o: Otocoder/src/com/sowrov/otocoder/http/PageDownloader.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -IOtocoder/src -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder/http/PageDownloader.o Otocoder/src/com/sowrov/otocoder/http/PageDownloader.cpp

${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder/main.o: Otocoder/src/com/sowrov/otocoder/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder
	${RM} "$@.d"
	$(COMPILE.cc) -g -IOtocoder/src -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder/main.o Otocoder/src/com/sowrov/otocoder/main.cpp
...
${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder/parser/TcHtmlParser.o: Otocoder/src/com/sowrov/otocoder/parser/TcHtmlParser.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -IOtocoder/src -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Otocoder/src/com/sowrov/otocoder/parser/TcHtmlParser.o Otocoder/src/com/sowrov/otocoder/parser/TcHtmlParser.cpp
...
${OBJECTDIR}/Otocoder/src/com/sowrov/util/logsystem/Calendar.o: Otocoder/src/com/sowrov/util/logsystem/Calendar.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -IOtocoder/src -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Otocoder/src/com/sowrov/util/logsystem/Calendar.o Otocoder/src/com/sowrov/util/logsystem/Calendar.cpp
...
${OBJECTDIR}/Otocoder/src/com/sowrov/util/logsystem/ChronicleLogger.o: Otocoder/src/com/sowrov/util/logsystem/ChronicleLogger.cpp 
	${MKDIR} -p ${OBJECTDIR}/Otocoder/src/com/sowrov/util/logsystem
	${RM} "$@.d"
	$(COMPILE.cc) -g -IOtocoder/src -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Otocoder/src/com/sowrov/util/logsystem/ChronicleLogger.o Otocoder/src/com/sowrov/util/logsystem/ChronicleLogger.cpp

${OBJECTDIR}/Otocoder/src/com/sowrov/util/logsystem/Console.o: Otocoder/src/com/sowrov/util/logsystem/Console.cpp 
	${MKDIR} -p ${OBJECTDIR}/Otocoder/src/com/sowrov/util/logsystem
	${RM} "$@.d"
	$(COMPILE.cc) -g -IOtocoder/src -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Otocoder/src/com/sowrov/util/logsystem/Console.o Otocoder/src/com/sowrov/util/logsystem/Console.cpp

${OBJECTDIR}/Otocoder/src/com/sowrov/util/logsystem/DiskFile.o: Otocoder/src/com/sowrov/util/logsystem/DiskFile.cpp 
	${MKDIR} -p ${OBJECTDIR}/Otocoder/src/com/sowrov/util/logsystem
	${RM} "$@.d"
	$(COMPILE.cc) -g -IOtocoder/src -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Otocoder/src/com/sowrov/util/logsystem/DiskFile.o Otocoder/src/com/sowrov/util/logsystem/DiskFile.cpp

${OBJECTDIR}/Otocoder/src/com/sowrov/util/logsystem/Html.o: Otocoder/src/com/sowrov/util/logsystem/Html.cpp 
	${MKDIR} -p ${OBJECTDIR}/Otocoder/src/com/sowrov/util/logsystem
	${RM} "$@.d"
	$(COMPILE.cc) -g -IOtocoder/src -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Otocoder/src/com/sowrov/util/logsystem/Html.o Otocoder/src/com/sowrov/util/logsystem/Html.cpp

${OBJECTDIR}/Otocoder/src/com/sowrov/util/logsystem/LevelManager.o: Otocoder/src/com/sowrov/util/logsystem/LevelManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/Otocoder/src/com/sowrov/util/logsystem
	${RM} "$@.d"
	$(COMPILE.cc) -g -IOtocoder/src -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Otocoder/src/com/sowrov/util/logsystem/LevelManager.o Otocoder/src/com/sowrov/util/logsystem/LevelManager.cpp

${OBJECTDIR}/Otocoder/src/com/sowrov/util/logsystem/PlainText.o: Otocoder/src/com/sowrov/util/logsystem/PlainText.cpp 
	${MKDIR} -p ${OBJECTDIR}/Otocoder/src/com/sowrov/util/logsystem
	${RM} "$@.d"
	$(COMPILE.cc) -g -IOtocoder/src -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Otocoder/src/com/sowrov/util/logsystem/PlainText.o Otocoder/src/com/sowrov/util/logsystem/PlainText.cpp
...
${OBJECTDIR}/Otocoder/src/com/sowrov/util/thread/ThreadLocker.o: Otocoder/src/com/sowrov/util/thread/ThreadLocker.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -IOtocoder/src -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Otocoder/src/com/sowrov/util/thread/ThreadLocker.o Otocoder/src/com/sowrov/util/thread/ThreadLocker.cpp
...
${OBJECTDIR}/Otocoder/src/com/sowrov/util/visualstudio/VSProject2008.o: Otocoder/src/com/sowrov/util/visualstudio/VSProject2008.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -IOtocoder/src -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Otocoder/src/com/sowrov/util/visualstudio/VSProject2008.o Otocoder/src/com/sowrov/util/visualstudio/VSProject2008.cpp
